...
class Application_Form_Utschememanualdata extends Zend_Form
{
...
public function addform()
	{
       ...
       $this->addElement('text', 'no_of_beneficiries_in_scheme', array( 			
		...
		$this->addElement('text', 'remarks', array( 			
            'required'   => false,
			'class'   => 'form-control',
            'filters'    => array('StringTrim'),
			'maxlength'  => '100',
		   ...
		   'validators' => array(
                array('Regex',
                    false,
                    array('/^[a-zA-Z0-9~`!#$^*_:?()@., \"\'\- \n\r ]{0,}$/i', 'messages'=>array( 'regexNotMatch'=>'Remarks field has special characters.Please remove them and try again.'))
				)),
