...
class Application_Model_Panchayat extends Zend_Db_Table_Abstract 
{
	// protected $_name = 'roles';
		public function insertpanchayat($dataform)
			...
			public function panchayatlist($start,$limit,$search)
			{   
			  ...
			  //echo "model".$search;
				...
				$select->from(array('l' => 'dbt_panchayat'), array('id','subdistrict_code','panchayat_name','panchayat_code','status','created','updated'));
				...
				$select->where('l.panchayat_name LIKE ?','%'.$search.'%')
			...
			public function countpanchayat()
			{
				...
				$select = $select_table->select();
				$select->setIntegrityCheck(false);
				$select->from(array('l' => 'dbt_panchayat'),array('id','subdistrict_code','panchayat_code','panchayat_name','status','created','updated'));	
		...
		public function editcontentmanagementtranslationdetails($editdataform,$id)
			...
			public function inactivepanchayatmanagement($projectIds,$sttaus)
			{
					$updatedetails_selecttable = new Zend_Db_Table('dbt_panchayat');
					$data="";
					$where="";
